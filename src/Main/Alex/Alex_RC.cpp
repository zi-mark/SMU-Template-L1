...
using namespace vex;
    ...
    //motor 马达名字(端口，变速箱比例，是否反转 0不反转1反转);
    motor R1(PORT17, ratio6_1, 1);
    motor R2(PORT18, ratio6_1, 1);
    motor R3(PORT19, ratio6_1, 1);
    motor L1(PORT14, ratio6_1, 0);
    ...
    motor LiftR(PORT1, ratio18_1, 0);
    motor LiftL(PORT9, ratio18_1, 1);

    int Lift_Count = 2;
    motor Lifts[] = {LiftR, LiftL};

    motor Suck(PORT10, ratio6_1, 1);
